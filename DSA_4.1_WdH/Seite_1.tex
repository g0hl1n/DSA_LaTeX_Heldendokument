...
\textbf{INI-Basiswert} & \BasisINImod & \BasisINIstart & \BasisINIaktuell & \multicolumn{2}{p{19mm}!{\VRule[3pt]}}{\tiny $\square$Kampfgespür(+2), $\square$Kampfreflexe(+4)}\\\hline
\textbf{AT-Basiswert} &  &  &  &  \multicolumn{2}{p{19mm}!{\VRule[3pt]}}{\multirow{3}{19mm}{{\footnotesize Wundschwelle} {\tiny (KO/2), Mod} \large \BasisWundschwelle}}\\\cline{1-4}
