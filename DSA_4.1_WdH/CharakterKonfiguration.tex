...
\def \EigMUmod{0}
\def \EigMUstart{0}
\def \EigMUgesteigert{0}
% Klugheit
\def \EigKLmod{0}
\def \EigKLstart{0}
\def \EigKLgesteigert{0}
% Intuition
\def \EigINmod{0}
\def \EigINstart{0}
\def \EigINgesteigert{0}
% Charisma
\def \EigCHmod{0}
\def \EigCHstart{0}
\def \EigCHgesteigert{0}
% Fingerfertigkeit
\def \EigFFmod{0}
\def \EigFFstart{0}
\def \EigFFgesteigert{0}
% Gewandtheit
\def \EigGEmod{0}
\def \EigGEstart{0}
\def \EigGEgesteigert{0}
% Konstitution
\def \EigKOmod{0}
\def \EigKOstart{0}
\def \EigKOgesteigert{0}
% Körperkraft
\def \EigKKmod{0}
\def \EigKKstart{0}
\def \EigKKgesteigert{3}
% Geschwindigkeit
\def \EigGSmod{0}
\def \EigGSstart{0}
\def \EigGSgesteigert{0}
