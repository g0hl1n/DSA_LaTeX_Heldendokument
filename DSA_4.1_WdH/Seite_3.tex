...
\multicolumn{2}{!{\VRule[3pt]}l|}{\footnotesize Rüstungsgewöhnung $\square$ I, $\square$ II, $\square$ III} & \RuestungsgewoehnungWert\\
\specialrule{3pt}{0pt}{0pt}
\end{tabular}
...
\multirow{4}{*}{\Large\textbf{\AusweichenPA \hspace{1pt} -}} & \multirow{4}{*}{\Large\textbf{\AusweichenBE \hspace{1pt}+ }} & {\tiny$\square$Ausweichen I (+3)} & \multirow{4}{*}{\Large\textbf{=\hspace{1pt} \AusweichenSumme}}\\
