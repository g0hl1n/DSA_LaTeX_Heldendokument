...
\def \footline{DSA-5 RWv2 \LaTeX\ Heldendokument v\version\ by g0hl1n - \url{https://github.com/g0hl1n/DSA_LaTeX_Heldendokument} - \today}
...
\begin{document}
\include{Seite_1} % erste Seite (Persönliche Daten, Vorteile, Nachteile, Grundwerte, Allg. SF, Schicksalspunkte)
\end{document}
